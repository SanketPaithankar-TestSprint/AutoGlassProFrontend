// src/components/PublicContact/index.js
export { default as PublicContactRoot } from './PublicContactRoot';
...
export { default as PublicContactFooter } from './PublicContactFooter';
