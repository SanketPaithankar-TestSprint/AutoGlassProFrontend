...
export const GLASS_OVERLAYS = [
    {
        ...
        src: sunroofSvg,
        alt: 'Sunroof pointer',
        className: 'w-45 h-22 absolute pointer-events-none opacity-90 transition-opacity duration-300',
    ...
    },
    {
        ...
        className: 'w-40 h-20 absolute pointer-events-none opacity-90 transition-opacity duration-300',
    ...
    },
    {
        ...
        className: 'w-80 h-25 rotate-[-90deg] absolute pointer-events-none opacity-90 transition-opacity duration-300',
    ...
    },
    {
        ...
        className: 'w-30 h-20 absolute pointer-events-none opacity-90 transition-opacity duration-300',
    ...
    },
    {
        ...
        className: 'w-40 h-15 absolute pointer-events-none opacity-90 transition-opacity duration-300',
