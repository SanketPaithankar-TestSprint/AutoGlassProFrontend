...
const ValuePropSection = () => {
    ...
    return (
        <>
                    ...
                    <AnimatedSection delay="0.4s">
                        <div className="text-center">
                            <BrandButton
                                ...
                                className="!rounded-full !px-12 !h-16 !text-lg !font-bold shadow-xl hover:shadow-2xl hover:-translate-y-1 transition-all !bg-[#7E5CFE] hover:!bg-[#7E5CFE]"
                            >
            ...
            <section className="relative bg-white pt-10 md:pt-12 pb-6 md:pb-10 flex items-center justify-center text-center border-t border-slate-100 overflow-hidden">
                ...
                <div className="max-w-6xl mx-auto px-6">
                    <div className="flex flex-col items-center">
                        ...
                        <motion.h2
                            ...
                            className="!text-6xl md:!text-[6.75rem] lg:!text-[8rem] !font-normal text-[#1e293b] !tracking-[-0.05em] !leading-[0.9] text-center !m-0"
                        >
                            <span className="text-[#7E5CFE]">Transform</span> Your
                        </motion.h2>
                        ...
                        <motion.h2
                            ...
                            transition={{ duration: 0.8, ease: "easeOut" }}
                            viewport={{ once: true, margin: "-50px" }}
                            className="!text-6xl md:!text-[6.75rem] lg:!text-[8rem] !font-normal !text-[#1e293b] mb-10 md:mb-12 !tracking-[-0.05em] !leading-[0.9] text-center"
                        >
                            Business?
                        </motion.h2>
                        ...
                        <motion.p
                            ...
                            transition={{ duration: 0.8, ease: "easeOut" }}
                            viewport={{ once: true, margin: "-50px" }}
                            className="text-[#334155] text-sm md:text-base lg:text-lg whitespace-nowrap max-w-none mx-auto leading-[1.4] mb-12 md:mb-16 font-normal"
                        >
