...
const ServiceLocationCard = ({ data }) => {
    ...
    if (!data) {
        return (
            <div className="bg-white/70 backdrop-blur-sm rounded-2xl border border-white/50 p-6 h-full flex items-center justify-center"
                ...
                <p className="text-slate-400">{t('analytics.noServiceLocationData')}</p>
            </div>
        );
    }
    ...
    const chartData = {
        labels: [t('analytics.inShop'), t('analytics.mobile')],
        datasets: [
            {
    ...
    return (
        <div className="bg-white/70 backdrop-blur-sm rounded-2xl border border-white/50 p-5 h-full flex flex-col"
            style={{ boxShadow: '0 4px 24px -4px rgba(0, 0, 0, 0.06)' }}>
            <h3 className="text-base font-bold text-slate-700 mb-3">{t('analytics.serviceLocation')}</h3>
            ...
            <div className="space-y-2">
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm text-slate-500">{t('analytics.inShop')}</span>
                    </div>
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm text-slate-500">{t('analytics.mobile')}</span>
                    </div>
                    <div className="text-right">
